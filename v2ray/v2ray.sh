...
# install v2ray
wget https://raw.githubusercontent.com/Dimas1441/gaskeun/main/v2ray/go.sh && dos2unix go.sh && chmod +x go.sh && ./go.sh
rm -f /root/go.sh
...
wget https://raw.githubusercontent.com/Dimas1441/gaskeun/main/v2ray/wildcard.sh && dos2unix wildcard.sh && chmod +x wildcard.sh && ./wildcard.sh
rm -f domain.sh
rm -f wildcard.sh
rm -f v2ray.sh
