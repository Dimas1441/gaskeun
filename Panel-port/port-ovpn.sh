...
echo -e "${red}Port OpenVPN TCP Berhasil Diganti Menjadi :${off} ${green} $vpn ${off}"
else
echo -e "${red}ERROR! Port{off} ${green}[ $vpn ]${off} ${red}Sudah Beroperasi Pada System!${off}"
echo -e "${red}Silahkan Gunakan Port Lain...${off}"
sleep 2
exit 0
fi
;;
...
echo -e "${red}Port OpenVPN UDP Berhasil Diganti Menjadi :${off} ${green} $vpn ${off}"
else
echo -e "${red}ERROR! Port{off} ${green}[ $vpn ]${off} ${red}Sudah Beroperasi Pada System!${off}"
echo -e "${red}Silahkan Gunakan Port Lain...${off}"
sleep 2
